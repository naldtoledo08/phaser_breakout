...
Bricks.prototype = {
    ...
    loadBricks1: function(){
        ...
        for(y = 1; y <= rowCount; y++){
            for(x= 1; x<= colCount; x++){
                _brick = bricks.create(170 + (x * 70), 100 + (y * 52), 'brick');
    ...
    loadBricks2: function(){
        ...
        for(y = 1; y <= rowCount; y++){
            for(x= 1; x<= colCount; x++){
                _brick = bricks.create(50 + (x * 70), 80 + (y * 52), 'brick');
                _brick.body.bounce.set(1);
                _brick.body.immovable = true;
            }
        }
        breakout.addSizeToPaddle(-20);
    },
